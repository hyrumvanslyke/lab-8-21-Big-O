...
// ANSWER: As the time complexity is the lowest it can be I cant find a solution with a better time complexity.
...
// ANSWER: Yes you can turn it into O(1) if no arrays are used
function improved(nums) {
  let ans = []
...
// ANSWER: In both functions, the space complexity is independent of the input size
